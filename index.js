...
function title() {
	  console.log(chalk.bold.blue(figlet.textSync('                  HIDEO', {
		font: 'Standard',
	...
	console.log(chalk.yellow(`\n                        ${chalk.red('        [ Store - Bot]')}\n\n${chalk.italic.magenta('• Author')} : ${chalk.white('Hideo')}\n${chalk.italic.magenta('• YouTube')} : ${chalk.white('Ramdan')}\n${chalk.italic.magenta('• Instagram')} : ${chalk.white('@hideo_souvenir')}\n${chalk.italic.magenta('• Note')} : ${chalk.white('Sc Store / Plugins / Case No Enc ? Buy Ke wa.me/6285798048936 ')}\n`))
}
