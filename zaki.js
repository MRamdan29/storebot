...
{buttonId: `.owner`, buttonText: {displayText: 'OWNER'}, type: 1},{buttonId: `.sewa`, buttonText: {displayText: 'SEWA BOT'}, type: 1}
 ...
 let pp = await getBuffer('https://telegra.ph/file/db3425ff63bd27de4d4da.jpg')
zaki.sendMessage(from, { document: fs.readFileSync('./media/logo.jpg'), mimetype: filerdm, caption: wiwik, jpegThumbnail: pp, fileName: `Haii ${pushname} 👋.`, fileLength: '99999999999999999', mentions: [m.sender, "6285798048936@s.whatsapp.net"], buttons: buttons, footer: '© Hyrobot -Md - Store', headerType: 4, contextInfo:{externalAdReply:{
showAdAttribution: true,
mediaType: 1,
               title: `HYRO BOT MD - BOT WA STORE`,
               renderLargerThumbnail: true,
               thumbnail: pp,
               sourceUrl: 'https://chat.whatsapp.com/GSPxsN2Ezma3ucdU9FhblV'
}} }, msg)
                   break
